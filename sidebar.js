...
// Допоміжна функція для відображення короткого ID кімнати (не обов’язкова, але корисна)
function getRoomName(roomId) {
  if (roomId.startsWith('!')) {
    // Відрізаємо префікс і лишаємо перші 8 символів
    return roomId.substring(1, 9);
  }
  return roomId;
}